...
// ---- Static: serve frontend (/frontend) ----
...
// ---- CORS (only needed if you’ll call API from another origin) ----
// If you are loading the frontend from the same Express app, you can remove this block.
...
app.get('/api/branches', async (_req, res) => {
    try {
        ...
        const activeBranches = branches
            ...
            .map(branch => ({ id: branch.id, branch_name: branch.branchName }))
...
app.get('/api/products', async (_req, res) => {
    try {
        ...
        const activeProducts = products
            ...
            .map(product => ({ product_id: product.productId, product_name: product.productName }))
...
app.get('/api/users', async (_req, res) => {
    try {
        ...
        const activeUsers = users
            ...
            .map(user => ({ user_id: user.userId, full_name: user.fullName }))
